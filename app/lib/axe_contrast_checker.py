    ...
    def add_visual_markers(self, html_content: str, violations: List[Dict]) -> str:
        ...
        for idx, violation in enumerate(violations):
            ...
            message = violation.get(
                "failure_summary", violation.get("message", "Color contrast issue")
            )
                ...
                if temp_soup and temp_soup.contents:
                    ...
                    if tag_name:
                        ...
                        for elem in elements:
                            ...
                            if (
                                element_html in elem_str
                                or elem.get_text(strip=True) in element_html
                            ):
                                ...
                                # Add tooltip
                                tooltip = soup.new_tag(
                                    "span", **{"class": "axe-contrast-tooltip"}
                                )
